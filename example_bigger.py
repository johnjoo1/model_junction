...
'''
1. Increased the width of the p and ntype layer.  Increase doping.  Did this so that the whole thing wouldn't be depleted.
2. Put grading doping ability by a function.
'''
